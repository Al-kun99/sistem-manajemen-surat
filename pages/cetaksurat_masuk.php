...
<?php
        ...
        <!-- Container START -->
            <div id="colres">
                <div class="disp">';
                        echo '<h4><img src="asset/img/logo1.png" width="50px"></h4>';
                ...
                $id_surat_masuk = mysqli_real_escape_string($link, $_REQUEST['id_surat_masuk']);
                $query = mysqli_query($link, "SELECT * FROM surat_masuk WHERE id_surat_masuk='$id_surat_masuk'");
                ...
                echo '
                    <table class="bordered" id="tbl">
                        <tbody>
                            <tr>
                                <td class="tgh" id="lbr" colspan="5">LEMBAR PENGANTAR SURAT MASUK</td>
                            </tr>
                            <tr>
                                <td id="right" width="12%"><strong>No. Surat</strong></td>
                                <td id="left" style="border-right: none;" width="55%">: '."MKB/".$row['nomor_surat_masuk']."/SAN/".$bulan."/".$tahun.'</td>

                            </tr>
                            <tr><td id="right"><strong>Tgl Surat</strong></td>
                                <td id="left" colspan="3">: '.($row['tanggal_surat_masuk']).'</td>
                            </tr>
                            <tr>
                                <td id="right"><strong>No. Berita</strong></td>
                            ...
                            <tr>
                                ...
                                <td id="left" colspan="3">: '.$row['pengirim'].'</td>
                            </tr>
                            <tr>
                                <td id="right"><strong>Kepada</strong></td>
                                <td id="left" colspan="3">: '.$row['kepada'].'</td>
                            </tr>
                            <tr>
